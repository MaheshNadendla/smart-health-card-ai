...
const isDeployment = import.meta.env.VITE_APP_ENV === "deployment";

// Chatbot API (Flask backend)
const CHATBOT_API = isDeployment 
  ? import.meta.env.VITE_PROD_CHATBOT_API_URL 
  : import.meta.env.VITE_LOCAL_CHATBOT_API_URL;

// Server API (Node/Express backend)
const SERVER_API = isDeployment 
  ? import.meta.env.VITE_PROD_SERVER_API_URL 
